...
class SafetyServiceFacilityLockRequestFromTest {
    ...
    @Test
    void updateFacilityReservationLock_setsRequestFromAdminPrefixWhenRoleAdmin() {
        Long facilityId = 10L;
        ...
        safetyService.updateFacilityReservationLock(new SafetyLockRequest(facilityId, SafetyLockCommand.LOCK));
        ...
        assertThat(savedLog.getRequestFrom()).isEqualTo("admin:admin01");
    }
}
