...
class SafetyServiceEventLogMappingTest {
    ...
    void listSafetyEventLogs_usesManualColumnAndNullifiesSensorFieldsForManualEvents() {
        ...
        assertThat(manualResponse.requestFrom()).isEqualTo("member:user123");
        ...
        assertThat(sensorResponse.requestFrom()).isEqualTo("sensor:55");
